...
! zstyle -t ":zephyr:plugin:local-environment" skip || return 0
...
if zstyle -T ':zephyr:plugin:local-environment' use-xdg-basedirs; then
...
# ! THIS BREAK THE SHELL ON MY MAC DUNNO WHY SO I REMOVED IT.
# https://github.com/mattmc3/zephyr/blob/main/plugins/environment/environment.plugin.zsh
...
#region MARK LOADED
zstyle ':zephyr:plugin:local-environment' loaded 'yes'
#endregion
