...
This document provides context and guidance for any tool when working with this dotfiles repository.

## Repository Overview

This is Radu's personal dotfiles repository, a comprehensive development
environment configuration for macOS, Linux and Windows WSL. The repository
follows a modern, structured approach using Task automation and Brew and Mise for
...
- XDG Base Directory compliance (most configs in `configs/`)
...
```
├── configs/               # XDG-compliant configuration files and dotfiles
...
- **Editor:** VSCode, Zed and Neovim (modern Lua configuration)
- **Terminal:** Ghostty, Warp as fallback
- **Shell:** Zsh with custom configuration
- **Multiplexer:** zellij pluggable terminal workspace, with terminal multiplexer as the base feature
- **Version Control:** Git with conventional commits

### Package Management

- **Homebrew:** GUI applications (casks) and system libraries
- **Mise:** Runtime management (Node, Rust, Python, etc.) and some CLI tools
...
```bash
git clone git@github.com:radum/dotfiles.git
cd dotfiles
./setup.sh
```
...
- **Zsh Config:** Modular files in `configs/zsh/`
...
- **Node.js 24 or latest LTS:** Managed via Mise
- **Ruby 3:** For various tools and scripts
- **Lua:** For Neovim configs
- **pnpm:** Package manager for Node.js dependencies

### Essential Tools (some auto-installed)
